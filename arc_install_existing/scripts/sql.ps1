...
$servicePrincipalAppId = "1744a508-a8e9-4316-9da6-ff347d398093"
$servicePrincipalTenantId = "f319ec31-b1f9-47ed-a2ac-dbc1a7031407"
$servicePrincipalSecret = "X-wtO6_SQwu2h1-K1-grxR-tUyD2pfJtb9"
...
$resourceGroup = "Arc-AWS-SQL-Demo"
...
$SecureString = ConvertTo-SecureString 'S3.qtCcDk-YIgrwNn8WYmqK)Z(keFhzE' -AsPlainText -Force
